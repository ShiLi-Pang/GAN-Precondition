...
Solving large-scale linear systems is a central challenge in applications such as **Frequency-domain Reverse Time Migration (FRTM)** and full waveform inversion.
